...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> getPrefs() async {
    ...
    DocumentSnapshot result = await userServices.getUserById(user!.uid);
